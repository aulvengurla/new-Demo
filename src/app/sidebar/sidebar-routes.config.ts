export const ROUTES = [
    ...
    { path: '#master', title: 'Master', icon: 'dashboard', children: [
      {path: 'master/country-stock', title: 'Country Stock Table', icon: 'PT'},
      {path: 'master/employee', title: 'Employee Table', icon: 'W'},
    ] },
    { path: 'country', title: 'Country', icon: 'content_paste', children: null },
    { path: 'employee', title: 'Employee', icon: 'notifications', children: null },
